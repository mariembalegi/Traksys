...
@Component({
  selector: 'app-unavailable-operator-card',
  imports: [CommonModule],
  templateUrl: './unavailable-operator-card.html',
  styleUrl: './unavailable-operator-card.scss'
})
export class UnavailableOperatorCard {
